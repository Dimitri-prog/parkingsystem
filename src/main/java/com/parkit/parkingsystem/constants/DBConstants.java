...
/**
 * Cette classe permet de stocker les requêtes SQL.
 */
public class DBConstants {
	...
	public static final String RECURRENT_VEHICLE = "select count(VEHICLE_REG_NUMBER) as VRN from TICKET t where t.VEHICLE_REG_NUMBER=?";
}
